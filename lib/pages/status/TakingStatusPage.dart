import 'package:delivery/pages/status/Rider_deliveryPage.dart';
import 'package:flutter/material.dart';

class TakingStatusPage extends StatelessWidget {
  const TakingStatusPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
                ...
                child: Stack(
                  children: const [
                    Positioned(
                      ...
                      right: 0,
                      child: Image(
                        image: AssetImage('assets/status_img/taking.png'),
                        height: 160,
                        width: 200,
                        fit: BoxFit.contain,
                      ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const RiderDeliverypage()),
          );
        },
