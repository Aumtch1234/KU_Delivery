import 'package:delivery/pages/status/chat_with_rider.dart';
import 'package:flutter/material.dart';
// <-- Add the correct import path for ChatWithRider

class RiderArrivedpage extends StatelessWidget {
  const RiderArrivedpage({Key? key}) : super(key: key);
    ...
    return Scaffold(
                ...
                child: Stack(
                  children: const [
                    Positioned(
                      ...
                      right: 0,
                      child: Image(
                        image: AssetImage('assets/status_img/locecion.webp'),
                        height: 160,
                        width: 200,
                        fit: BoxFit.contain,
                      ),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildLine(),
                    _buildStatusIcon(Icons.location_on, true),
                  ],
                ),
              ],
            ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const ChatWithRider()),
          );
        },
