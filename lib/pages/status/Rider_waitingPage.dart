import 'package:delivery/pages/status/Rider_delivering_foodPage.dart';
import 'package:flutter/material.dart';

class RiderWaitingpage extends StatelessWidget {
  const RiderWaitingpage({Key? key}) : super(key: key);
                ...
                child: Stack(
                  children: const [
                    Positioned(
                      ...
                      right: 0,
                      child: Image(
                        image: AssetImage('assets/status_img/craf.webp'),
                        height: 160,
                        width: 200,
                        fit: BoxFit.contain,
                      ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const RiderDeliveringFoodpage(),
            ),
          );
        },
